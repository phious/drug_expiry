    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <h2 class="card-title">
                        <?php 
                            $batch_query = mysqli_query($conn, "SELECT * FROM distribution_center");
                            $row_count = mysqli_num_rows($batch_query);
                            echo $row_count; 
                        ?>
                    </h2>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <h2>Batch</h2>
                    <h2 class="card-title" id="batch_list">
                        <?php 
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <h2 class="card-title" id="batch_list">
                        <?php 
                            $expiry = mysqli_query($conn, "SELECT status FROM drug_table WHERE status = 0");
